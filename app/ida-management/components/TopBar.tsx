      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className="lg:hidden p-2 text-gray-400 hover:text-gray-600 hover:bg-[#F5F4E7] rounded-lg transition-colors"
          >
          ...
          <form onSubmit={handleSearch} className="relative max-w-md">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-[#E8E6CF] dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#007BFF] focus:border-transparent w-full bg-[#F5F4E7] dark:bg-gray-700 focus:bg-[#F5F4E7] dark:focus:bg-gray-600 transition-colors text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            />
          </form>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button 
            ...
            className="relative p-2 text-gray-400 hover:text-gray-600 hover:bg-[#F5F4E7] rounded-lg transition-colors"
          >
          ...
          <div className="relative" ref={userDropdownRef}>
            <button 
              ...
              className="flex items-center space-x-3 hover:bg-[#F5F4E7] rounded-lg p-2 transition-colors"
            >
            ...
            {/* User Dropdown Menu */}
            {isUserDropdownOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white border border-[#E8E6CF] rounded-lg shadow-lg z-50">
                {/* User Info Header */}
